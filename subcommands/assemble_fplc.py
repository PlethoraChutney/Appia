...
def append_chroms(file_list):
    ...
    for file in file_list:
        ...
        try:
            ...
            long_trace.drop('inst_frac', inplace = True, axis = 1)
...
# * 2.1 csv generation ---------------------------------------------------------
    ...
    if int(low_ml) == 0 and int(high_ml) == 0:
        print('zero zero')
        low_ml = str(int(min(compiled['mL'])))
        high_ml = str(int(max(compiled['mL'])))
...
parser.add_argument(
    ...
    help = 'Inclusive range for x-axis, in mL. Default is 5 to 25. 0 0 selects full range.'
)
parser.add_argument(
    '-c', '--copy-manual',
