...
parser = argparse.ArgumentParser(description="Database management", add_help=False)
...
parser.add_argument(
    "-d", "--delete", help="Delete experiment(s) by name", type=str, nargs="+"
)
parser.add_argument(
    "-i", "--inspect", help="Print information about experiments", type=str, nargs="+"
)
parser.add_argument(
    "--download",
